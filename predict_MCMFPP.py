...
def get_config():
    ...
    parse.add_argument('-lr_slfe', type=float, default=0.0019, help='Learning rate for SLFE')
    ...
    parse.add_argument('-W2', type=float, default=0, help='Weight for the CFEC sub-classification prediction tail')
    ...
    parse.add_argument('-mcmfpp_predictions', type=str, default='save1/mcmfpp_predictions.txt', help='Save the results of MCMFPP peptide prediction')
...
# classifier_SLFE = torch.load(f'save1/classifier_slfe_{args.random_seed}_19.pth')
# classifier_CFEC = torch.load(f'save1/classifier_cfec_{args.random_seed}_7.pth')
