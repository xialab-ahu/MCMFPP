...
def get_config():
    ...
    parse.add_argument('-peptides_name', type=list,
                       default=['AAP', 'ABP', 'ACP.txt', 'ACVP', 'ADP', 'AEP', 'AFP', 'AHIVP','AHP', 'AIP', 'AMRSAP', 'APP',
                                'ATP', 'AVP', 'BBP', 'BIP', 'CPP', 'DPPIP', 'QSP', 'SBP','THP'], help='Types of therapeutic peptides in the dataset')
    # Model parameters
    parse.add_argument('-max_length', type=int, default=52, help='Maximum allowed length for sequence word encoding')
    parse.add_argument('-model', type=str, default='ESMC', help='Choose the model: ESMC')
    ...
    parse.add_argument('-position_embedding_dim', type=int, default=128,
                       help='Embedding dimension of positional encoding word vectors (128). If it equals 0, positional encoding is not performed')
    parse.add_argument('-ESMC_embedding_dim', type=int, default=960,
                       help='0 or 960. 0 indicates that ESMC extraction is not used')
    ...
    parse.add_argument('-test_direction', type=str, default='../MFTP/test.txt',
                       help='Location where the test set is stored')
...
if __name__ == "__main__":
    ...
    if tag_labels1:
        ...
        savepath = f'../Figures/ESMC_multiple_TSNE.png'
